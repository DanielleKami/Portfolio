...
let projects = [
   {
    image: 'textures/recipes.png',
    url: 'https://github.com/DanielleKami/Webanwendung-Rezepte-NutzerVerwaltung',
  },
  {
    image: 'textures/catan.png',
    url: 'https://github.com/DanielleKami/Catan-Live-View',
  },
  {
    image: 'textures/taschenrechner.png',
    url: ' https://github.com/DanielleKami/Taschenrechner-mit-Python',
  },
  {
    image: 'textures/GoL.png',
    url: 'https://github.com/DanielleKami/GameOfLife-Java',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('DANIELLE NOELLE KAMI TENI', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'INFORMATIKSTUDENTIN|SOFTWAREENTWICKLUNG | KI',
      {
        font: font,
        size: 0.018,
        height: 0,
